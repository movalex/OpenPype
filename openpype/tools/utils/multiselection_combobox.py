...
class MultiSelectionComboBox(QtWidgets.QComboBox):
    ...
    def __init__(self, parent=None, placeholder="", separator=", ", **kwargs):
    ...
    def paintEvent(self, event):
        ...
        for line, items in self._lines.items():
            ...
            for item in items:
                ...
                bg_rect.setWidth(label_rect.width() + self.left_right_padding)
    ...
    def value(self):
        ...
        for idx in range(self.count()):
            ...
            if state == QtCore.Qt.Checked:
                items.append(self.itemData(idx, role=QtCore.Qt.UserRole))
        return items
